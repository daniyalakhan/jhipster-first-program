...
describe('Tag e2e test', () => {
    ...
    it('should load Tags', () => {
        ...
        expect(tagComponentsPage.getTitle()).toMatch(/jhipsterfirstprogramApp.tag.home.title/);
    ...
    it('should load create Tag dialog', () => {
        ...
        expect(tagDialogPage.getModalTitle()).toMatch(/jhipsterfirstprogramApp.tag.home.createOrEditLabel/);
        tagDialogPage.close();
    });
