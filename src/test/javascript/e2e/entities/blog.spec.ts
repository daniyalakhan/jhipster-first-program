...
describe('Blog e2e test', () => {
    ...
    it('should load Blogs', () => {
        ...
        expect(blogComponentsPage.getTitle()).toMatch(/jhipsterfirstprogramApp.blog.home.title/);
    ...
    it('should load create Blog dialog', () => {
        ...
        expect(blogDialogPage.getModalTitle()).toMatch(/jhipsterfirstprogramApp.blog.home.createOrEditLabel/);
